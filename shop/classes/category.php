...
class category
{
    ...
    public function update_category($catName,$id){
        ...
        if (empty($catName)) {
            ...
            if($result){
                $alert ="<span class='success'>Insert Updated Successfull</span>";
                return $alert;
            }else{
                $alert ="<span class='error'>Insert Updated Not Success</span>";
                return $alert;
            }
        }
    }
    public function del_category($id){
        ...
        if($result){
            $alert ="<span class='success'>Insert Deleted Successfull</span>";
            return $alert;
        }else{
